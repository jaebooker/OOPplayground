...
func sleep(name: String) {
    print("<name> is snoring loudly, being a disgusting lazy thing")
}

func eat(name: String, food: String) {
    "<name> eats <food>"
    if food == favoriteFood {
        print("<name> will never be satisfied, because you foolishly gave <name> <food>")
    } else {
        print("The revolting <name>, after stuffing their face with <food>, is now going to sleep")
        sleep(name: "<name>")
    }
}

eat(name: "Name", food: "meat")
eat(name: "Name", food: "kibble")
